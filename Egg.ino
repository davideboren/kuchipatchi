Egg::Egg(const uint8_t *bitmap1, const uint8_t *bitmap2, const uint8_t *bitmap3, unsigned int age, MonsterName next){
...
void Egg::queueHatch1(){
	moveInstrQueue[0].setMove(4,0,-1,0,2);
	moveInstrQueue[1].setMove(8,0,1,0,2);
	moveInstrQueue[2].setMove(8,0,-1,0,2);
	moveInstrQueue[3].setMove(8,0,1,0,2);
	
	moveInstrQueuePos = 0;
}

void Egg::queueHatch2(){
	moveInstrQueue[0].setMove(4,0,-1,0,3);
